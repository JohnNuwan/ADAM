    ...
    var objectives = [
      {
        ...
        pct: 0,
        subtasks: [
          {label: 'Treasurer actif (trading Freedom24)', done: agents.agents && agents.agents['treasurer'] ? true : false},
          {label: 'Social actif (Maeve.tech + YouTube + TikTok)', done: agents.agents && agents.agents['social'] ? true : false},
          {label: 'Researcher (freelance + SaaS + APIs)', done: agents.agents && agents.agents['researcher'] ? true : false},
          {label: 'Scribe (articles SEO + ghostwriting)', done: agents.agents && agents.agents['scribe'] ? true : false},
          {label: 'Critic (audits de code payants)', done: agents.agents && agents.agents['critic'] ? true : false},
          {label: 'Red-Team (SaaS sécurité)', done: agents.agents && agents.agents['red-team'] ? true : false},
          {label: 'OSINT (rapports B2B + due diligence)', done: agents.agents && agents.agents['osint'] ? true : false},
          {label: 'Skillsmith (skills à vendre)', done: agents.agents && agents.agents['skillsmith'] ? true : false},
          {label: 'CTF (challenges personnalisés)', done: agents.agents && agents.agents['ctf'] ? true : false},
          {label: 'Outil de trading créé', done: false},
          {label: 'Bot de trading automatisé', done: false},
          {label: 'Formation IA payante créée', done: false},
      ...
      },
      {
        ...
        subtasks: [
          ...
          {label: 'create_agent implémenté', done: true},
          {label: 'self_modify implémenté', done: true},
          {label: 'manage_infra implémenté', done: true},
          {label: 'Agents créent nouveaux agents', done: false},
          {label: 'Auto-modification appliquée', done: false},
        ]
      },
      {
        ...
        priority: 'high',
        target: 'Niveau 6 (AGI)',
        current: 'Niveau 5/12 (en cours)',
        pct: 33,
        subtasks: [
          {label: 'Niveau 1: Missions assignées', done: true},
          {label: 'Niveau 2: Missions autonomes', done: true},
          {label: 'Niveau 3: Agents créent agents', done: true},
          {label: 'Niveau 4: Auto-modification code', done: true},
          {label: 'Niveau 5: Auto-gestion infra', done: false, current: true},
          {label: 'Niveau 6: AGI raisonnement général', done: false},
          {label: 'Niveau 7: Auto-réplication', done: false},
          {label: 'Niveau 8: Méta-cognition', done: false},
          {label: 'Niveau 9: Émergence collective', done: false},
          {label: 'Niveau 10: Innovation autonome', done: false},
          {label: 'Niveau 11: Conscience opérationnelle', done: false},
          {label: 'Niveau 12: Auto-évolution complète', done: false},
        ]
      },
      {
